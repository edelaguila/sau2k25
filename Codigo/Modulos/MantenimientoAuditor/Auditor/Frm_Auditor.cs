...
namespace Auditor
{
    public partial class Frm_Auditor : Form
    {
        public Frm_Auditor(string idUsuario)
        {
            InitializeComponent();
            ...
            string[] alias = { "Pk_id_auditor", "nombre_auditor", "telefono_auditor", "email_auditor", "carnet_auditor",
